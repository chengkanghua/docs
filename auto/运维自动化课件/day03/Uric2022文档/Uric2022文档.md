...
![image-20220619上午85556213](assets/image-20220619上午85556213-5600157.png)
...
<template>
    ...
    <a-table :dataSource="dataSource" :columns="hostFormColumns"/>
    <div>
...
urlpatterns = [
  	path('category/', views.CategorysView.as_view()),  #主机分类数据
      path('host/', views.HostView.as_view({'get': 'list', 'post': 'create'})), #主机数据
]
...
![image-20220619上午92311000](assets/image-20220619上午92311000-5601792.png)

![image-20220619上午92352627](assets/image-20220619上午92352627-5601833.png)
