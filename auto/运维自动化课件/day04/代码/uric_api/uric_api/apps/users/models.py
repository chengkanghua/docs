...
# 命令行： python manage.py createsuperuser  yuan 123
# 代码：User.objects.create_user(username="yuan",password="123")
# 代码：User.objects.create_superuser(username="yuan",password="123")
