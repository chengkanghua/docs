...
function filterTable(elem) { // eslint-disable-line no-unused-vars
    ...
    <h1>report.htmnl</h1>
    <p>Report generated on 22-May-2022 at 06:27:05 by <a href="https://pypi.python.org/pypi/pytest-html">pytest-html</a> v3.1.1</p>
    <h2>Environment</h2>
    <table id="environment">
      ...
      <tr>
        <td>Plugins</td>
        <td>{"html": "3.1.1", "metadata": "2.0.1", "ordering": "0.6", "rerunfailures": "10.2"}</td></tr>
      <tr>
        <td>Python</td>
